  ...
  const categoryData = [
    {
      id: 1,
      name: "Skincare",
      image: "/cat-skincare.jpg",
      color: "bg-rose-50",
      link: "/category/body-care" // ✅ MATCHES YOUR WORKING ROUTE
    },
    {
      id: 2,
      name: "Makeup",
      ...
      color: "bg-purple-50",
      link: "/category/lips" // ✅ MATCHES YOUR WORKING ROUTE
    },
    {
      id: 3,
      name: "Haircare",
      ...
      color: "bg-blue-50",
      link: "/category/hair-care" // ✅ MATCHES YOUR WORKING ROUTE
    },
    {
      id: 4,
      name: "Fragrance",
      ...
      color: "bg-yellow-50",
      link: "/category/perfume" // ✅ MATCHES YOUR WORKING ROUTE
    }
  ];
